...
| 11 | Refactor structurel puis validation des paliers Escalade | ✅ validation des paliers livrée (même patron que le choix de thème du duel, vérifiée e2e 10/10 : montée à deux, refus anonyme) — le refactor structurel (découpe des fichiers, workspace, CI) reste le prochain chantier |
